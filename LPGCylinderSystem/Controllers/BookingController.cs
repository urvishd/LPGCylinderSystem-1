...
namespace LPGCylinderSystem.Controllers
{
    ...
    public class BookingController : Controller
    {
        ...
        public IActionResult ChooseMethod(string cylindertype, IFormCollection formCollection)
        {
            ...
            HttpContext.Session.SetString(SessionCyltype, cylindertype);
        ...
        public async Task<IActionResult> COD()
        {
            ...
            var book1 = new Booking { Booking_Id = ObjectId.GenerateNewId().ToString(), BookingDate = DateTime.Now, PaymentMethod = "Cash On Delivery", SubsidyAmount = 0, OrderStatus = "Confirmed", DAC = "0" };
            ...
            if (otp1 == (HttpContext.Session.GetInt32(SessionOtp1)).ToString())
            {
              ...
              .FirstOrDefaultAsync(m => m.CardNumber == HttpContext.Session.GetString(Sessioncard1));
                ...
                if (book == null)
                {
                    ...
                    book1 = new Booking { Booking_Id = ObjectId.GenerateNewId().ToString(), BookingDate = DateTime.Now, PaymentMethod = "Card", SubsidyAmount = 0, OrderStatus = "Confirmed-Payment Received", DAC = dac.ToString() };
                    bookings.Add(book1);
        ...
        public async Task<IActionResult> Netbankingpayment(string bank, string uname, string passwd)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    var book1 = new Booking { Booking_Id = ObjectId.GenerateNewId().ToString(), BookingDate = DateTime.Now, PaymentMethod = "Netbanking", SubsidyAmount = 0, OrderStatus = "Confirmed-Payment Received", DAC = dac.ToString() };
                    ViewBag.id1 = book1.Booking_Id;
                    book.Add(book1);
                    user1.Result.Bookings = book;
